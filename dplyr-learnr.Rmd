...
In each section, there will be examples and practice activities. You will complete practice activities in code chunks, like the one below. Once you enter your activity code, press 'Run' to see the output. If you get stuck, press the 'Hint' or 'Solution' button.

```{r calculator, exercise = TRUE}
2 + 3
```

When you press 'Run', the **output** of the code is returned below it.
...
Move on to meet the penguins in Section 2!
...
Starting with `penguins`, filter to only keep Adélie and gentoo penguins, then find counts by species and sex. 
...
- Only keep observations for Adélie penguins
